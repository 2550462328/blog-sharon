...
<div class="content-wrapper">
    ...
    <section class="content-header" id="animated-header">
        ...
        <a class="btn-header" id="btnOpenAttach" href8="javascript:void(0)" onclick="halo.layerModal('/admin/attachments/select?type=post','<@spring.message code="common.js.all-attachment" />')">
