        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="">
                    <li><a data-pjax="false" href="/admin/posts"><i class="fa fa-circle-o"></i><@spring.message code='admin.menu.all-posts' /></a></li>
                    <li><a data-pjax="false" href="/admin/posts/write"><i class="fa fa-circle-o"></i><@spring.message code='admin.menu.new-post' /></a></li>
                    <li><a data-pjax="false" href="/admin/category"><i class="fa fa-circle-o"></i><@spring.message code='admin.menu.categories' /></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a data-pjax="true" href="/admin/tools"><i class="fa fa-circle-o"></i><@spring.message code='admin.menu.smallTool' /></a></li>
                </ul>
            </li>
            <li class="treeview">
                <a data-pjax="true" href="javascript:void(0)">
                    <i class="fa fa-cog"></i>
                    <span><@spring.message code='admin.menu.hello-test' /></span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a data-pjax="true" href="/hello/test"><i class="fa fa-circle-o"></i><@spring.message code='admin.menu.test' /></a></li>
                </ul>
            </li>
        </ul>
    </section>
