...
public class PostController extends BaseController {
    ...
    public String posts(Model model,
        ...
        model.addAttribute("categoryList", categoryService.findAllByCatePid(0));
    ...
    public String searchPost(Model model,
                             ...
                             @RequestParam(value = "search_category") Long search_category,
                             @RequestParam(value = "select_name") String select_name,
                             @RequestParam(value = "status", defaultValue = "0") Integer status,
                             @RequestParam(value = "publishCount") Integer publishCount,
                             @RequestParam(value = "draftCount") Integer draftCount,
                             @RequestParam(value = "trashCount") Integer trashCount,
                             @RequestParam(value = "page", defaultValue = "0") Integer page,
                             @RequestParam(value = "size", defaultValue = "10") Integer size) {
        try {
