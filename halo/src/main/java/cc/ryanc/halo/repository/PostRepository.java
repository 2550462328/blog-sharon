...
public interface PostRepository extends JpaRepository<Post, Long> {
     ...
     * @return List
     */
    Page<Post> findByPostTitleIsLikeOrPostIdIsInAndPostStatus(String keyword, long[] postIds, Integer status, Pageable pageable);
     ...
     * @return Page
     */
    Page<Post> findPostsByPostStatusAndPostTypeAndPostIdIsIn(Integer status, String postType, long[] postIds, Pageable pageable);
