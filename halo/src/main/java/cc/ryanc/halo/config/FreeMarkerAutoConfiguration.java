...
import cc.ryanc.halo.config.freemarker.RoleTagDirective;
...
public class FreeMarkerAutoConfiguration {
    ...
    @Autowired
    private RoleTagDirective roleTagDirective;
    ...
    public void setSharedVariable() {
        try {
            ...
            configuration.setSharedVariable("roleTag", roleTagDirective);
