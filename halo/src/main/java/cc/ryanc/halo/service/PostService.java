...
public interface PostService {
     ...
     * @return List
     */
    Page<Post> searchPosts(String keyWord, long[] postIds, Integer status, Pageable pageable);
     ...
     * @return Page
     */
    Page<Post> findPostByCondition(Pageable pageable, String keyword, Long cateId);
     ...
     * @date 2019/12/23
     */
    List<Post> sortPostByCate(Page<Post> inPage);
